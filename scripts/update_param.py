...
if not os.path.isfile(hdprm_target_file):
    shutil.copy(f"{hdprm_dir}/HodoParam_e72_example", hdprm_target_file)
...
if not os.path.isfile(hdphc_target_file):
    shutil.copy(f"{hdphc_dir}/HodoPHCParam_e72_example", hdphc_target_file)
...
if not os.path.isfile(dctdc_target_file):
    shutil.copy(f"{dctdc_dir}/DCTdcParam_e72_example", dctdc_target_file)
...
if not os.path.isfile(dcgeo_target_file):
    shutil.copy(f"{dcgeo_dir}/DCGeomParam_e72_example", dcgeo_target_file)
