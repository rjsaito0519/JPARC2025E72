...
group.add_argument('--dc', action="store_true", help='Set mode to DC (BcIn/BcOut common) calibration (Legacy)')
...
PARAM_DEFS = {
    "USER:":   {"dir": "USER",   "prefix": "UserParam_run",        "tpl": "UserParam_e72_20250518"},
    "HDPRM:":  {"dir": "HDPRM",  "prefix": "HodoParam_run",        "tpl": "HodoParam_00344"},
    "HDPHC:":  {"dir": "HDPHC",  "prefix": "HodoPHCParam_run",     "tpl": "HodoPHCParam_00344"},
    "DCTDC:":  {"dir": "DCTDC",  "prefix": "DCTdcParam_run",       "tpl": "DCTdcParam_00344"},
    "DCDRFT:": {"dir": "DCDRFT", "prefix": "DCDriftParam_run",     "tpl": "DCDriftParam_00344.root"},
    "DCGEO:":  {"dir": "DCGEO",  "prefix": "DCGeomParam_run",      "tpl": "DCGeomParam_e72_20250813"},
}
...
for suffix in args.suffix:
    ...
    if not conf_target_file.exists():
        example_base = "analyzer_e72_20250823.conf"
    ...
    if mode_label == "hodo":
        ...
        # Default fallback (includes bcout and dc)
